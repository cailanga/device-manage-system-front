...
export default {
    ...
    methods: {
        ...
        getGoods() {
            ...
            this.$http.post("/nowarehousinggoods/checking", this.query)
                .then(data => {
        ...
        getGoodsTypes() {
            this.$http.get("/nowarehousinggoodsType")
                .then(result=>{
                    result = result.data;
                    if (result.success) {
                        this.nowarehousinggoodsTypes = result.resultObject;
                    }
                })
        },
        //删除
            ...
            this.$refs.saveForm.validate((valid) => {
                if (valid) {
                    this.$confirm('确认提交吗？', '提示', {}).then(() => {
                        ...
                        this.$http.post("/nowarehousinggoods/handle", this.saveForm).then((data) => {
