<template>
    <section>
      ...
      <!--处理界面-->
      <el-dialog title="入库处理" :visible.sync="saveFormVisible" :close-on-click-modal="false">
...
export default {
    ...
    methods: {
        ...
        getDevices() {
            ...
            this.$http.post("/nowarehousingdevices/checking", this.query)
                .then(data => {
        ...
        getDevicesTypes() {
            this.$http.get("/nowarehousingdevicesType")
                .then(result=>{
                    result = result.data;
                    if (result.success) {
                        this.nowarehousingdevicesTypes = result.resultObject;
                    }
                })
        },
        //删除
            ...
            this.$refs.saveForm.validate((valid) => {
                if (valid) {
                    this.$confirm('确认提交吗？', '提示', {}).then(() => {
                        ...
                        this.$http.post("/nowarehousingdevices/handle", this.saveForm).then((data) => {
